(function () {
    ...
    function Connection(options) {
        ...
        if (this.config.SSLRejectUnauthorized) {
          this.config.SSLRejectUnauthorized = true;
        } else {
          this.config.SSLRejectUnauthorized = false;
        }
        this.collist = {};
    ...
    Connection.prototype.updateColumnDefinitions = function () {
        ...
        return new Promise(function (resolve, reject) {
          ...
          var options = {
              ...
              'rejectUnauthorized': that.config.SSLRejectUnauthorized
		        }
        ...
        var restOptions = that.queryBuilder(sql).then(function(restOptions){
          ...
          switch (restOptions.method) {
              case 'GET':
                  ...
                  requestOptions.rejectUnauthorized = that.config.SSLRejectUnauthorized;
          ...
          return callback(error, 0,0,null);
        });
      } catch(error) {
        return callback(error, 0,0,null);
      }
        ...
        return new Promise(function (resolve, reject) {
          ...
          switch (keyword.toUpperCase()) {
              ...
              case 'DELETE' :
                  ...
                  break;
              default:
                  reject(new Error('Cannot find keyword \'' + keyword + '\''));
          }
    ...
    Connection.prototype.sqlCommand = function(sql, callback) {
      ...
      var options = {
         ...
         callback(null, obj.rowset.rows, affectedRows, obj.rowset.coldesc);
   	 });
   };
